                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ (!empty($adminData->profile_image)) ? asset('uploads/admin_images/'.$adminData->profile_image) : asset('uploads/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
                                <div class="mt-3">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{ (!empty($adminData->profile_image)) ? asset('uploads/admin_images/'.$adminData->profile_image) : asset('uploads/no_image.jpg') }}" id="showImage" alt="Admin" class="avatar-xl rounded p-1 bg-primary" width="110">
                                    </div>
                                </div>
