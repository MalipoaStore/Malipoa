        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.change.password') }}"><i class='bx bx-home-circle'></i><span>Change Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.profile.logout') }}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
