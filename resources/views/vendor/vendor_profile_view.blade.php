                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="{{ (!empty($vendor->profile_image)) ? asset('uploads/admin_images/'.$vendor->profile_image) : asset('uploads/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
                                <div class="mt-3">
                                    <h4>{{ $vendor->name }}</h4>
                                    <p class="text-secondary mb-1">{{ $vendor->username }}</p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('vendor.profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" class="form-control" name="username" value="{{ $vendor->username }}" disabled />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="vendor_join" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea class="form-control" id="inputAddress" name="vendor_short_info" placeholder="Vendor info" rows="3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{ (!empty($vendor->profile_image)) ? asset('uploads/admin_images/'.$vendor->profile_image) : asset('uploads/no_image.jpg') }}" id="showImage" alt="Admin" class="avatar-xl rounded p-1 bg-primary" width="110">
                                    </div>
                                </div>
