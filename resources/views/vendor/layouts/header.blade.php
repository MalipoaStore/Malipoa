        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($adminData->profile_image)) ? asset('uploads/admin_images/'.$adminData->profile_image) : asset('uploads/no_image.jpg') }}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('vendor.change.password') }}"><i class='bx bx-home-circle'></i><span>Change Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{ route('vendor.profile.logout') }}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
